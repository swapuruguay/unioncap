...
if(isset($_FILES['file-0'])) {
  ...
  $ruta = '../upload/noticias/';
  $sql = "INSERT INTO novedades (titulo, cuerpo, estado, ruta) VALUES('". $_POST['titulo']. "','". $_POST['cuerpo'] . "','1','". $nombreImagen ."')";
  ...
  $obj_img	->set("anchoDestino"	, 700);
  $obj_img	->set("calidadImagen"	, 1000);
